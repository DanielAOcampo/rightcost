        ...
        <div id="container">
            ...
            <aside class="t-sidebar">
                <div class="nav-welcome">
                    <span>Welcome Admin</span><a href="#" class="btn-collapse"><span class="fa fa-arrow-circle-left"></span></a>
                </div>
                <div class="navbar-header">
                    <a class="navbar-brand" href="#">Rightcost</a>
                </div>
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li class="dropdown active">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    ...
                                    <span id="admin-user">My Account</span> <b class="caret"></b></a>
